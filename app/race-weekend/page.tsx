...
export default function RaceWeekendPage() {
  return (
    <div className="space-y-6">
      <Panel title="Race Weekend" subtitle="Round: — • Sprint weekend: — • Last updated: —">
        ...
        <div className="mt-3 text-xs text-white/50">
          Later this becomes a real selector + per-snapshot view.
        </div>
      </Panel>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Panel title="Biggest Gainers" subtitle="QUALI → FINAL delta (points)">
          <div className="rounded-xl border border-white/10 bg-black/20 p-4 text-sm text-white/80">
            ...
            <div className="mt-2 text-white/50">… top 10</div>
          </div>
        </Panel>
      ...
      <Panel title="Pick Breakdown" subtitle="Ownership for drivers & constructors (this round)">
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-white/10 bg-black/20 p-4">
            <div className="text-xs font-semibold text-white">Constructors ownership</div>
            <div className="mt-3 space-y-2 text-sm text-white/80">
              <div>1) — (—%)</div>
              <div>2) — (—%)</div>
              <div>3) — (—%)</div>
